...
import gamemakerstudio_.misc.ImprovedNoise;
            ...
            for (int i = 0; i < N; i++) {
                for (int j = 0; j < N; j++) {
                    ...
                    g.setColor(new Color(
                            game_.clamp((int)d, 0, 255),
                            game_.clamp((int)(d + 50) % 255, 0, 255),
                            0
                    ));
...
//                stroke(255);
        ...
        int constrain(int var, int min, int max){
            return game_.clamp(var, min, max);
        }
        double constrainDouble(double var, double min, double max){
            return game_.clampDouble(var, min, max);
        }
    }
