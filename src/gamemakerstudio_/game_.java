...
import gamemakerstudio_.entities.experimental.betterosc_;
import gamemakerstudio_.entities.experimental.camera_;
import gamemakerstudio_.entities.experimental.rendertexture_;
...
//        handler.addObject(new camera_(0, 0, ID.NULL, this));
    ...
    public void endCodes() {
        hud.HEALTH = 100;
        hud2.HEALTH = 100;
        if (gameState != STATE.Load) gameState = STATE.End;
