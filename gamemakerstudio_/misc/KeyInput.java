    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (!game.paused) {
            ...
            if (key == KeyEvent.VK_SLASH) {
                if (game.playerTwoGunLoadOut == game_.GUN.Default)
                    game.playerTwoGunLoadOut = game_.GUN.Chlorophyte;
                else if (game.playerTwoGunLoadOut == game_.GUN.Chlorophyte)
                    game.playerTwoGunLoadOut = game_.GUN.Electrocute;
                else if (game.playerTwoGunLoadOut == game_.GUN.Electrocute)
                    game.playerTwoGunLoadOut = game_.GUN.Default;
                if (game_.music) audioplayer_.getSound("click_sound").play();
            }

            // p1 switch gun
            if (key == KeyEvent.VK_C) {
                if (game.playerOneGunLoadOut == game_.GUN.Default)
                    game.playerOneGunLoadOut = game_.GUN.Chlorophyte;
                else if (game.playerOneGunLoadOut == game_.GUN.Chlorophyte)
                    game.playerOneGunLoadOut = game_.GUN.Electrocute;
                else if (game.playerOneGunLoadOut == game_.GUN.Electrocute)
                    game.playerOneGunLoadOut = game_.GUN.Default;
                if (game_.music) audioplayer_.getSound("click_sound").play();
            }
            ...
            if (key == KeyEvent.VK_Z) {
                ...
                if (game.gameState == STATE.Game && game.diff == 0) {
                    hud.resetTimer();
                ...
                if (game.gameState == STATE.Game && game.diff == 1) {
                    hud.resetTimer();
                    handler.clearEnemies();
                    hud.setLevel(1);
                    spawn_.scoreKeep = 0;
            ...
            if (key == KeyEvent.VK_ESCAPE) {
                if (game_.music && game.gameState != STATE.Menu)
        ...
        if (key == KeyEvent.VK_P) {
            ...
            if (game.gameState == STATE.GameBeta) {
                if (game.paused) {
                    game.paused = false;
                    audioplayer_.getMusic(audioplayer_.currentMusic).resume();
                } else {
                    game.paused = true;
